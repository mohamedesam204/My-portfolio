        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-305 dark:border-slate-800 focus:border-sky-500 outline-none transition-colors text-sm text-slate-800 dark:text-white"
              />
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-305 dark:border-slate-800 focus:border-sky-500 outline-none transition-colors text-sm resize-none text-slate-800 dark:text-white"
            />
          </div>
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 rounded-xl bg-gradient-to-r from-sky-500 to-indigo-650 hover:from-sky-400 hover:to-indigo-500 text-white font-bold shadow-lg hover:shadow-sky-500/25 transition-all flex items-center justify-center gap-2 text-sm disabled:opacity-70"
            >
              {loading ? (
                <>
