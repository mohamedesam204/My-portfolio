      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            <span className="text-[10px] uppercase font-mono px-2.5 py-1.5 rounded-lg bg-slate-200/60 dark:bg-slate-800/60 text-slate-650 dark:text-slate-350 font-bold">
              English Section
            </span>
            <span className="text-[10px] uppercase font-mono px-2.5 py-1.5 rounded-lg bg-slate-200/60 dark:bg-slate-800/60 text-slate-650 dark:text-slate-350 font-bold">
